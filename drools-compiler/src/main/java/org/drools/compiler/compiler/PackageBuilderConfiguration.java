...
public class PackageBuilderConfiguration
	...
	private static final String TAG = "PackageBuilderConfiguration";
    ...
    private void init(Properties properties,
        ...
        init( properties );
//        System.out.println("\ni'm "+TAG+" i addDialect[Java,Mvel]");
//        addDialect("java", "org.drools.compiler.rule.builder.dialect.java.JavaDialectConfiguration");
//        addDialect("mvel", "org.drools.compiler.rule.builder.dialect.mvel.MVELDialectConfiguration");
    }
...
//        System.out.println("\ni'm "+TAG+" in method: setDefaultDialect ::: i set string defaultdialect to \"java\"\n");
