...
public class RuleBuilder {
	...
	private static String TAG = "RuleBuilder";
    ...
    public void build(final RuleBuildContext context) {
    	...
    	System.out.println("\ni'm: "+TAG+" in method: BUILD\n");
    	
        RuleDescr ruleDescr = context.getRuleDescr();
        
        System.out.println(TAG+" --> " + ruleDescr.getName() + " --> "+ruleDescr.getDialect());
//        	Dialect TESTdialect = context.getDialect();
//        	AndDescr TESTadndescr = ruleDescr.getLhs();
//        	Class<? extends AndDescr> TESTClass = TESTadndescr.getClass();
//        	RuleConditionBuilder TESTrulecondbuilder = (RuleConditionBuilder) TESTdialect.getBuilder(TESTadndescr.getClass());
//        	EngineElementBuilder TESTEngineelS = TESTdialect.getBuilder(TESTClass);
//        	RuleConditionBuilder TESTEngineelS = (RuleConditionBuilder) TESTdialect.getBuilder(TESTClass);
